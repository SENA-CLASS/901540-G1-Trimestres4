...
public class PropietarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.ingresoceet.interacion.entities.PropietarioPK[ equipoSerial=" + equipoSerial + ", cuentaTipoDocumentotipodocumento=" + cuentaTipoDocumentotipodocumento + ", cuentanumeroDocumento=" + cuentanumeroDocumento + " ]";
    }
