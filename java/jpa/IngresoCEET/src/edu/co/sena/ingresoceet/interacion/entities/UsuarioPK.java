...
public class UsuarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.ingresoceet.interacion.entities.UsuarioPK[ cuentaTipoDocumentotipodocumento=" + cuentaTipoDocumentotipodocumento + ", cuentanumeroDocumento=" + cuentanumeroDocumento + " ]";
    }
