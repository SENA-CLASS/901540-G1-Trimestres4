...
public class ItemCarritoPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tiendaenlinea.integracion.entities.ItemCarritoPK[ carritoComprasIdCarrito=" + carritoComprasIdCarrito + ", productoIdProducto=" + productoIdProducto + " ]";
    }
