...
public class DomicilioCuentasPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tiendaenlinea.integracion.entities.DomicilioCuentasPK[ cuentaTipoDocumentoTipoDocumento=" + cuentaTipoDocumentoTipoDocumento + ", cuentaNumeroDocumento=" + cuentaNumeroDocumento + " ]";
    }
