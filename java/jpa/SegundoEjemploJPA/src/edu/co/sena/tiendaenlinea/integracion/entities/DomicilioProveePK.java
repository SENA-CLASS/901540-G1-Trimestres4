...
public class DomicilioProveePK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.tiendaenlinea.integracion.entities.DomicilioProveePK[ proveedorTipoDocumentoTipoDocumento=" + proveedorTipoDocumentoTipoDocumento + ", proveedorNumDocumento=" + proveedorNumDocumento + " ]";
    }
