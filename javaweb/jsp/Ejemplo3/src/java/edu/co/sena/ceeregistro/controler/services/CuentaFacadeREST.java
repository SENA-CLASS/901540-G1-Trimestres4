...
import edu.co.sena.ceeregistro.model.entities.CuentaPK;
 ...
 */
@Stateless
@Path("edu.co.sena.ceeregistro.model.entities.cuenta")
public class CuentaFacadeREST extends AbstractFacade<Cuenta> {
    ...
    private CuentaPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        edu.co.sena.ceeregistro.model.entities.CuentaPK key = new edu.co.sena.ceeregistro.model.entities.CuentaPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        edu.co.sena.ceeregistro.model.entities.CuentaPK key = getPrimaryKey(id);
