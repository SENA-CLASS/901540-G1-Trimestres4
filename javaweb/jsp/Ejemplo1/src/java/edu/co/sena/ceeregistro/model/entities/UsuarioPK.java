...
public class UsuarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.ceeregistro.model.entities.UsuarioPK[ cuentaTipoDocumentotipodocumento=" + cuentaTipoDocumentotipodocumento + ", cuentanumeroDocumento=" + cuentanumeroDocumento + " ]";
    }
