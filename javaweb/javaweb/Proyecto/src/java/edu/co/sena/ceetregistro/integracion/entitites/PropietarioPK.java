...
public class PropietarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.ceetregistro.integracion.entitites.PropietarioPK[ equipoSerial=" + equipoSerial + ", cuentaTipoDocumentotipodocumento=" + cuentaTipoDocumentotipodocumento + ", cuentanumeroDocumento=" + cuentanumeroDocumento + " ]";
    }
