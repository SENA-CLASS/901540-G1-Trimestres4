...
public class UsuarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.ceetregistro.integracion.entitites.UsuarioPK[ cuentaTipoDocumentotipodocumento=" + cuentaTipoDocumentotipodocumento + ", cuentanumeroDocumento=" + cuentanumeroDocumento + " ]";
    }
