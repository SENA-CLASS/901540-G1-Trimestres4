...
import edu.co.sena.ceetregistro.integracion.entitites.Equipo;
...
import edu.co.sena.ceetregistro.negocio.ejbs.EquipoFacade;
...
public class EquipoController implements Serializable {
    ...
    @EJB
    private edu.co.sena.ceetregistro.negocio.ejbs.EquipoFacade ejbFacade;
