...
public class CuentaPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.ejemploproyecto.integracion.entities.CuentaPK[ tipoDocumentotipodocumento=" + tipoDocumentotipodocumento + ", numeroDocumento=" + numeroDocumento + " ]";
    }
