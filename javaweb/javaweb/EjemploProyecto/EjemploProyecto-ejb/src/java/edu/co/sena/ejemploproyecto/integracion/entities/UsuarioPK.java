...
public class UsuarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.ejemploproyecto.integracion.entities.UsuarioPK[ cuentaTipoDocumentotipodocumento=" + cuentaTipoDocumentotipodocumento + ", cuentanumeroDocumento=" + cuentanumeroDocumento + " ]";
    }
