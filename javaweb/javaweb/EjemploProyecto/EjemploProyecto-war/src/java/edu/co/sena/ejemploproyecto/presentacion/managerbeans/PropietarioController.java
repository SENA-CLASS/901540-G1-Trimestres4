package edu.co.sena.ejemploproyecto.presentacion.managerbeans;

import edu.co.sena.ejemploproyecto.integracion.entities.Propietario;
import edu.co.sena.ejemploproyecto.presentacion.managerbeans.util.JsfUtil;
import edu.co.sena.ejemploproyecto.presentacion.managerbeans.util.JsfUtil.PersistAction;
import edu.co.sena.ejemploproyecto.negocio.ejbs.PropietarioFacade;
...
public class PropietarioController implements Serializable {
    ...
    @EJB
    private edu.co.sena.ejemploproyecto.negocio.ejbs.PropietarioFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setPropietarioPK(new edu.co.sena.ejemploproyecto.integracion.entities.PropietarioPK());
    }
    ...
    public Propietario getPropietario(edu.co.sena.ejemploproyecto.integracion.entities.PropietarioPK id) {
    ...
    public static class PropietarioControllerConverter implements Converter {
        ...
        edu.co.sena.ejemploproyecto.integracion.entities.PropietarioPK getKey(String value) {
            edu.co.sena.ejemploproyecto.integracion.entities.PropietarioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.ejemploproyecto.integracion.entities.PropietarioPK();
        ...
        String getStringKey(edu.co.sena.ejemploproyecto.integracion.entities.PropietarioPK value) {
