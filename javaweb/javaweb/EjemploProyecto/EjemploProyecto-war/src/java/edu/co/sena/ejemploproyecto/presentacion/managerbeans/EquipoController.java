...
import edu.co.sena.ejemploproyecto.integracion.entities.Equipo;
...
import edu.co.sena.ejemploproyecto.negocio.ejbs.EquipoFacade;
...
public class EquipoController implements Serializable {
    ...
    @EJB
    private edu.co.sena.ejemploproyecto.negocio.ejbs.EquipoFacade ejbFacade;
