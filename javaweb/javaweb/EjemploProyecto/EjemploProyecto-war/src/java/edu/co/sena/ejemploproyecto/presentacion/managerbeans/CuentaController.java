...
import edu.co.sena.ejemploproyecto.negocio.ejbs.CuentaFacade;
...
public class CuentaController implements Serializable {
    ...
    @EJB
    private edu.co.sena.ejemploproyecto.negocio.ejbs.CuentaFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setCuentaPK(new edu.co.sena.ejemploproyecto.integracion.entities.CuentaPK());
    }
    ...
    public Cuenta getCuenta(edu.co.sena.ejemploproyecto.integracion.entities.CuentaPK id) {
    ...
    public static class CuentaControllerConverter implements Converter {
        ...
        edu.co.sena.ejemploproyecto.integracion.entities.CuentaPK getKey(String value) {
            edu.co.sena.ejemploproyecto.integracion.entities.CuentaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new edu.co.sena.ejemploproyecto.integracion.entities.CuentaPK();
            key.setTipoDocumentotipodocumento(values[0]);
            key.setNumeroDocumento(values[1]);
            return key;
        }

        String getStringKey(edu.co.sena.ejemploproyecto.integracion.entities.CuentaPK value) {
