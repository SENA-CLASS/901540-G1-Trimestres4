 ...
 */
package edu.co.sena.ejemplojee2.integracion.entities;
...
public class PropietarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.ejemplojee2.integracion.entities.PropietarioPK[ equipoSerial=" + equipoSerial + ", cuentaTipoDocumentotipodocumento=" + cuentaTipoDocumentotipodocumento + ", cuentanumeroDocumento=" + cuentanumeroDocumento + " ]";
    }
