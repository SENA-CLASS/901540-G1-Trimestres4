...
public class UsuarioPK implements Serializable {
    ...
    public String toString() {
        return "edu.co.sena.ejemplojee2.integracion.entities.UsuarioPK[ cuentaTipoDocumentotipodocumento=" + cuentaTipoDocumentotipodocumento + ", cuentanumeroDocumento=" + cuentanumeroDocumento + " ]";
    }
