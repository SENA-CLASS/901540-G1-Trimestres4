...
public class PropietarioPK implements Serializable {
    ...
    public String toString() {
        return "e.PropietarioPK[ equipoSerial=" + equipoSerial + ", cuentaTipoDocumentotipodocumento=" + cuentaTipoDocumentotipodocumento + ", cuentanumeroDocumento=" + cuentanumeroDocumento + " ]";
    }
