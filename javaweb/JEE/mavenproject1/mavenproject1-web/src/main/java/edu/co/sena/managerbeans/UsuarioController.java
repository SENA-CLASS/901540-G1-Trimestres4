...
import edu.co.sena.ejbs.UsuarioFacade;
...
public class UsuarioController implements Serializable {
    ...
    @EJB (lookup = "java:module/UsuarioFacade")
    private edu.co.sena.ejbs.UsuarioFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setUsuarioPK(new entities.UsuarioPK());
    }
    ...
    public Usuario getUsuario(entities.UsuarioPK id) {
    ...
    public static class UsuarioControllerConverter implements Converter {
        ...
        entities.UsuarioPK getKey(String value) {
            entities.UsuarioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new entities.UsuarioPK();
            key.setCuentaTipoDocumentotipodocumento(values[0]);
            key.setCuentanumeroDocumento(values[1]);
            return key;
        }

        String getStringKey(entities.UsuarioPK value) {
