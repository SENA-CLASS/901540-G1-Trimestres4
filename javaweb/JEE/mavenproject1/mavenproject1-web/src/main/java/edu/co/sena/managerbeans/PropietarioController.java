...
import edu.co.sena.ejbs.PropietarioFacade;
...
public class PropietarioController implements Serializable {
    ...
    @EJB (lookup = "java:module/PropietarioFacade")
    private edu.co.sena.ejbs.PropietarioFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setPropietarioPK(new entities.PropietarioPK());
    }
    ...
    public Propietario getPropietario(entities.PropietarioPK id) {
    ...
    public static class PropietarioControllerConverter implements Converter {
        ...
        entities.PropietarioPK getKey(String value) {
            entities.PropietarioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new entities.PropietarioPK();
        ...
        String getStringKey(entities.PropietarioPK value) {
