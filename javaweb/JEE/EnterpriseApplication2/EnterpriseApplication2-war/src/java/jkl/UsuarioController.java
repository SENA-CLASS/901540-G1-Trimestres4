...
public class UsuarioController implements Serializable {
    ...
    @EJB
    private k.UsuarioFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setUsuarioPK(new e.UsuarioPK());
    }
    ...
    public Usuario getUsuario(e.UsuarioPK id) {
    ...
    public static class UsuarioControllerConverter implements Converter {
        ...
        e.UsuarioPK getKey(String value) {
            e.UsuarioPK key;
        ...
        String getStringKey(e.UsuarioPK value) {
