...
public class CuentaController implements Serializable {
    ...
    @EJB
    private k.CuentaFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setCuentaPK(new e.CuentaPK());
    }
    ...
    public Cuenta getCuenta(e.CuentaPK id) {
    ...
    public static class CuentaControllerConverter implements Converter {
        ...
        e.CuentaPK getKey(String value) {
            e.CuentaPK key;
        ...
        String getStringKey(e.CuentaPK value) {
