...
import jkl.util.JsfUtil;
import jkl.util.JsfUtil.PersistAction;
import k.PropietarioFacade;
...
public class PropietarioController implements Serializable {
    ...
    @EJB
    private k.PropietarioFacade ejbFacade;
    ...
    protected void initializeEmbeddableKey() {
        selected.setPropietarioPK(new e.PropietarioPK());
    }
    ...
    public Propietario getPropietario(e.PropietarioPK id) {
    ...
    public static class PropietarioControllerConverter implements Converter {
        ...
        e.PropietarioPK getKey(String value) {
            e.PropietarioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new e.PropietarioPK();
        ...
        String getStringKey(e.PropietarioPK value) {
